...
?>
<nav id="navbar-auto-hidden" class="navbar-expand navbar-warning bg-dark">
        <div class="row hidden-xs">
            <div class="col-xs-4">
                <p class="text-navbar tittles-pages-logo">Oaxaca Tradicional</p>
            </div>
            <div class="col-xs-8">
    ...
    <div id="mobile-menu-list" class="hidden-sm hidden-md hidden-lg">
        <br>
        <h3 class="text-center tittles-pages-logo">OAXACA TRADICIONAL</h3>
