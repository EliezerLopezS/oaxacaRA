    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-4">
                ...
                <p> 
                 Oaxaca Tradicional y sus artesanos milenarios   </br>
                    
                </p>
            </div>
            <div class="col-sm-4">
                <h4 class="text-footer" >Direccion</h4>
                <p style="color: #FFF">Av. San Miguel No. 815 Barrio San Miguel Tlaxiaco Oaxaca </p>
                <p style="color: #FFF">adipisicing elit</p>
                <p class="fa fa-mobile" style="font-size:20px"  aria-hidden="true">  Tel Cel: 9531953182</p> <a href="#" target="_blank" style="color: #5bc0de">envianos_un_mensaje</a></br>
                E-mail: <a href="#" target="_blank" style="color: #5bc0de"> &nbsp;oaxacatradicional@dominio.com</a>
            </div>
        </div>
    </div>
    <br><br><br>
    <h5 class="text-center tittles-pages-logo text-footer">Oaxaca Tradicional &copy; </h5>
</footer>
