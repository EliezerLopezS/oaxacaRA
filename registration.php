    ...
    <section id="form-registration">
        <div class="container">
            <div class="page-header">
              <h1>REGISTRO <small class="tittles-pages-logo">OAXACA TRADICIONAL</small></h1>
            </div>
            ...
            <div class="row">
                <div class="col-sm-5 text-center">
                    <figure>
                   <img src="./assets/img/oaxaca.jpg" alt="imagen" class="img-responsive">
                    </figure>
                </div>
                <div class="col-sm-7">
                            ...
                            <div class="row">
                              ...
                              <div class="col-xs-12">
                                <div class="form-group label-floating">
                                  ...
                                  <input class="form-control" type="text" required name="clien-nit"  title="Ingrese su CURP"  maxlength="18" onblur="this.value=this.value.toUpperCase()">
